...
The menu for new basic reports is already created. By default, it is located under :menuselection:`Accounting -> Reporting`. Then, on the generic report (e.g :guilabel:`Balance Sheet`), it will be selectable as a variant report.
